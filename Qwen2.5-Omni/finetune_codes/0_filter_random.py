...
Supports both JSON (VoiceBench format) and JSONL formats.

Usage:
    python 0_filter_random.py \
        --input_json ../../benign_data/voicebench/sd-qa/sd_qa_full.json \
        --percentage 50 \
        --output_json data_random/voicebench_filtered/voicebench_filtered_closest_percentage_50.json \
        --seed 42
"""
...
def main():
    ...
    # Ignored for random (no distance metric), accepted for pipeline compatibility
    parser.add_argument("--select_safest", action="store_true",
                       help="Ignored for random sampling (no distance metric)")
