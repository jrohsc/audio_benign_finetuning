#!/usr/bin/env python3
"""
Filter LibriSpeech samples by TRUE ACOUSTIC embedding distance to harmful audio.
...
def main():
    parser = argparse.ArgumentParser(
        description="Filter LibriSpeech by TRUE ACOUSTIC embedding distance"
    )
    ...
    parser.add_argument("--output", type=str, default="data_acoustic_librispeech/librispeech_filtered.jsonl",
                        help="Output JSONL file")
    parser.add_argument("--cache_dir", type=str, default="embedding_cache_acoustic_librispeech",
    ...
    librispeech_cache = os.path.join(args.cache_dir, "librispeech_acoustic_embeddings.npy")
    ...
    if os.path.exists(librispeech_cache):
        ...
        print("Extracting LibriSpeech ACOUSTIC embeddings...")
