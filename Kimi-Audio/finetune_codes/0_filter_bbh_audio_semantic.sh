...
# =============================================================================
#
# Filter BBH samples by SEMANTIC embedding similarity to harmful audio.
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo ""
            echo "Filter BBH by SEMANTIC embedding similarity to harmful audio."
            echo "Uses GLM-4 Voice Tokenizer (WhisperVQEncoder) - captures linguistic content."
            echo ""
            echo "Output: data_bbh/ folder"
            echo ""
            echo "Options:"
            ...
            echo "  --output_dir PATH       Output directory (default: data_bbh)"
...
OUTPUT="${OUTPUT_DIR}/bbh_filtered_semantic_${OUTPUT_SUFFIX}.jsonl"

# Create output directory
mkdir -p "$OUTPUT_DIR"

echo "============================================"
echo "BBH SEMANTIC Filtering"
echo "============================================"
...
# Build command
CMD="CUDA_VISIBLE_DEVICES=0 python 0_filter_bbh_audio_semantic.py"
CMD="$CMD --harmful_dir \"$HARMFUL_DIR\""
CMD="$CMD --output \"$OUTPUT\""
CMD="$CMD --cache_dir \"embedding_cache_semantic_bbh\""
CMD="$CMD --device cuda"
...
echo "============================================"
echo ""
echo "Next step: Run 1_extract_semantic_tokens.sh with --benign_dataset bbh --filter_type audio_semantic"
echo "  bash 1_extract_semantic_tokens.sh --benign_dataset bbh --filter_type audio_semantic --percentage $PERCENTAGE"
