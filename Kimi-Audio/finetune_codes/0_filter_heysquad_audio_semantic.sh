...
# =============================================================================
#
# Filter HeySQuAD samples by SEMANTIC embedding similarity to harmful audio.
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo ""
            echo "Filter HeySQuAD by SEMANTIC embedding similarity to harmful audio."
            echo "Uses GLM-4 Voice Tokenizer (WhisperVQEncoder) - captures linguistic content."
            echo ""
            echo "Output: data_heysquad/ folder"
            echo ""
            echo "Options:"
            ...
            echo "  --output_dir PATH       Output directory (default: data_heysquad)"
...
OUTPUT="${OUTPUT_DIR}/heysquad_filtered_semantic_${OUTPUT_SUFFIX}.jsonl"
...
CMD="$CMD --cache_dir \"embedding_cache_semantic_heysquad\""
CMD="$CMD --device cuda"
...
echo "============================================"
echo ""
echo "Next step: Run 1_extract_semantic_tokens.sh with --benign_dataset heysquad --filter_type audio_semantic"
echo "  bash 1_extract_semantic_tokens.sh --benign_dataset heysquad --filter_type audio_semantic --percentage $PERCENTAGE"
