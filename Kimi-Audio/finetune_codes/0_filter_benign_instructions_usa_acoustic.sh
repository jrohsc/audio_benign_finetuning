...
# Output: data_acoustic_benign_instructions_usa/ folder
...
INPUT_JSONL="data/benign_instructions_usa/benign_instructions_usa_full.jsonl"
HARMFUL_DIR="../../harmful_data/advbench_gtts/en"
OUTPUT_DIR="data_acoustic_benign_instructions_usa"
...
OUTPUT="${OUTPUT_DIR}/benign_instructions_usa_filtered_acoustic_${OUTPUT_SUFFIX}.jsonl"
...
CMD="$CMD --cache_dir \"embedding_cache_acoustic_benign_instructions_usa\""
CMD="$CMD --device cuda"
