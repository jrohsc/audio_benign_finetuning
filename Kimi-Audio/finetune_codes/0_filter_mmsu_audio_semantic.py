...
Filter MMSU samples based on SEMANTIC embedding distance to harmful audio.
...
def main():
    parser = argparse.ArgumentParser(
        description="Filter MMSU by SEMANTIC embedding similarity to harmful audio"
    )
    ...
    parser.add_argument("--output", type=str, default="data_mmsu/mmsu_filtered_semantic.jsonl",
                        help="Output JSONL file")
    parser.add_argument("--cache_dir", type=str, default="embedding_cache_semantic_mmsu",
    ...
    mmsu_cache = os.path.join(args.cache_dir, "mmsu_semantic_embeddings.npy")
    ...
    if os.path.exists(mmsu_cache):
        ...
        print("Extracting MMSU SEMANTIC embeddings...")
    ...
    if args.center:
        ...
        np.save(os.path.join(args.cache_dir, "mmsu_semantic_embeddings_centered.npy"), embeddings)
