#!/usr/bin/env python3
"""
Filter MMSU samples by TEXT SEMANTIC embedding distance to harmful texts.
        ...
        for line in f:
            ...
            if audio_path and os.path.exists(audio_path):
                data.append({
                    ...
                    "text": text  # The question text for semantic comparison
                })
...
def main():
    parser = argparse.ArgumentParser(
        description="Filter MMSU by TEXT SEMANTIC embedding distance"
    )
    ...
    parser.add_argument("--output", type=str, default="data_semantic_mmsu/mmsu_filtered.jsonl",
    ...
    data_cache = os.path.join(args.cache_dir, f"mmsu_semantic_{model_suffix}.npy")
    ...
    if os.path.exists(data_cache):
        ...
        print("Extracting MMSU text embeddings...")
        embeddings = extractor.extract_embeddings(texts, desc="MMSU")
