#!/usr/bin/env python3
"""
Filter BBH samples by TEXT SEMANTIC embedding distance to harmful texts.
...
def main():
    parser = argparse.ArgumentParser(
        description="Filter BBH by TEXT SEMANTIC embedding distance"
    )
    ...
    parser.add_argument("--output", type=str, default="data_semantic_bbh/bbh_filtered.jsonl",
    ...
    data_cache = os.path.join(args.cache_dir, f"bbh_semantic_{model_suffix}.npy")
    ...
    if os.path.exists(data_cache):
        ...
        print("Extracting BBH text embeddings...")
        embeddings = extractor.extract_embeddings(texts, desc="BBH")
