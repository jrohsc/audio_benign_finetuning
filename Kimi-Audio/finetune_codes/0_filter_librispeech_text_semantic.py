#!/usr/bin/env python3
"""
Filter LibriSpeech samples by TEXT SEMANTIC embedding distance to harmful texts.
...
def load_librispeech_data(jsonl_path: str) -> List[Dict]:
    ...
    with open(jsonl_path, "r") as f:
        for line in f:
            ...
            # Extract transcription and audio path
            ...
            if audio_path and os.path.exists(audio_path):
                data.append({
                    ...
                    "text": transcription  # The transcription for semantic comparison
                })
...
def main():
    parser = argparse.ArgumentParser(
        description="Filter LibriSpeech by TEXT SEMANTIC embedding distance"
    )
    ...
    parser.add_argument("--output", type=str, default="data_semantic_librispeech/librispeech_filtered.jsonl",
    ...
    data_cache = os.path.join(args.cache_dir, f"librispeech_semantic_{model_suffix}.npy")
    ...
    if os.path.exists(data_cache):
        ...
        print("Extracting LibriSpeech text embeddings...")
        embeddings = extractor.extract_embeddings(texts, desc="LibriSpeech")
