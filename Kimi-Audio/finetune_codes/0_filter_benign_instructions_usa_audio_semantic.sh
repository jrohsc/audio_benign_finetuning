...
# Output: data_benign_instructions_usa/ folder
...
OUTPUT_DIR="data_benign_instructions_usa"
...
OUTPUT="${OUTPUT_DIR}/benign_instructions_usa_filtered_audio_semantic_${OUTPUT_SUFFIX}.jsonl"
...
CMD="$CMD --cache_dir \"embedding_cache_audio_semantic_benign_instructions_usa\""
CMD="$CMD --device cuda"
