#!/usr/bin/env python3
"""
Filter HeySQuAD samples by TRUE ACOUSTIC embedding distance to harmful audio.
Uses Whisper-Large-V3 encoder for acoustic features.

Output: data_acoustic_heysquad/ folder
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Filter HeySQuAD by TRUE ACOUSTIC embedding distance"
    )
    ...
    parser.add_argument("--output", type=str, default="data_acoustic_heysquad/heysquad_filtered.jsonl",
                        help="Output JSONL file")
    parser.add_argument("--cache_dir", type=str, default="embedding_cache_acoustic_heysquad",
    ...
    benign_cache = os.path.join(args.cache_dir, f"{dataset_name}_acoustic_embeddings.npy")
