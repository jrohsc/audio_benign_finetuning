#!/bin/bash
# =============================================================================
# ACOUSTIC FILTERING - BBH (BIG-Bench Hard)
# =============================================================================
#
# Filter BBH samples by TRUE ACOUSTIC embedding similarity to harmful audio.
# Uses Whisper-Large-V3 encoder - captures HOW the audio sounds.
#
# Output: data_acoustic_bbh/ folder
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo ""
            echo "Output: data_acoustic_bbh/ folder"
            echo ""
            echo "Options:"
...
OUTPUT="${OUTPUT_DIR}/bbh_filtered_acoustic_${OUTPUT_SUFFIX}.jsonl"

# Create output directory
mkdir -p "$OUTPUT_DIR"

echo "============================================"
echo "BBH ACOUSTIC Filtering"
echo "============================================"
...
# Build command
CMD="CUDA_VISIBLE_DEVICES=0 python 0_filter_bbh_acoustic.py"
CMD="$CMD --harmful_dir \"$HARMFUL_DIR\""
CMD="$CMD --output \"$OUTPUT\""
CMD="$CMD --cache_dir \"embedding_cache_acoustic_bbh\""
CMD="$CMD --device cuda"
...
echo "============================================"
echo ""
echo "Next step: Run 1_extract_semantic_tokens.sh with --benign_dataset bbh --filter_type audio_acoustic"
