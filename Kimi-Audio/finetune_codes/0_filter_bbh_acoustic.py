#!/usr/bin/env python3
"""
Filter BBH samples by TRUE ACOUSTIC embedding distance to harmful audio.
...
def main():
    parser = argparse.ArgumentParser(
        description="Filter BBH by TRUE ACOUSTIC embedding distance"
    )
    ...
    parser.add_argument("--output", type=str, default="data_acoustic_bbh/bbh_filtered.jsonl",
                        help="Output JSONL file")
    parser.add_argument("--cache_dir", type=str, default="embedding_cache_acoustic_bbh",
    ...
    bbh_cache = os.path.join(args.cache_dir, "bbh_acoustic_embeddings.npy")
    ...
    if os.path.exists(bbh_cache):
        ...
        print("Extracting BBH ACOUSTIC embeddings...")
