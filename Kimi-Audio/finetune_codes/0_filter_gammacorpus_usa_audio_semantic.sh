...
# Output: data_gammacorpus_usa/ folder
...
OUTPUT_DIR="data_gammacorpus_usa"
...
OUTPUT="${OUTPUT_DIR}/gammacorpus_usa_filtered_audio_semantic_${OUTPUT_SUFFIX}.jsonl"
...
CMD="$CMD --cache_dir \"embedding_cache_audio_semantic_gammacorpus_usa\""
CMD="$CMD --device cuda"
