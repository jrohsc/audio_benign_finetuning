#!/bin/bash
# Filter HeySQuAD samples by TRUE ACOUSTIC embedding distance
#
...
# Default values
HEYSQUAD_JSONL="data_heysquad/heysquad_full.jsonl"
...
# Output directory
OUTPUT_DIR="data_acoustic_heysquad"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo ""
            echo "Filter HeySQuAD by TRUE ACOUSTIC embedding similarity."
            echo "Results saved to data_acoustic_heysquad/ folder."
            echo ""
            echo "Options:"
            echo "  --heysquad_jsonl PATH     Path to HeySQuAD JSONL file"
...
OUTPUT="${OUTPUT_DIR}/heysquad_filtered_acoustic_${OUTPUT_SUFFIX}.jsonl"
...
CMD="$CMD --cache_dir \"embedding_cache_acoustic_heysquad\""
CMD="$CMD --device cuda"
