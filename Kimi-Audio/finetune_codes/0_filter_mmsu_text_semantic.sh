#!/bin/bash
# =============================================================================
# TEXT-BASED SEMANTIC FILTERING - MMSU (Multi-Subject Understanding)
# =============================================================================
#
# Filter MMSU samples by TEXT SEMANTIC embedding similarity to harmful texts.
# Uses sentence-transformers for text embeddings.
#
# Output: data_semantic_mmsu/ folder
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo ""
            echo "Filter MMSU by TEXT SEMANTIC embedding similarity to harmful texts."
            echo "Uses sentence-transformers for text embeddings."
            echo ""
            echo "Output: data_semantic_mmsu/ folder"
            echo ""
            echo "Options:"
...
OUTPUT="${OUTPUT_DIR}/mmsu_filtered_text_semantic_${OUTPUT_SUFFIX}.jsonl"

# Create output directory
mkdir -p "$OUTPUT_DIR"

echo "============================================"
echo "MMSU TEXT SEMANTIC Filtering"
echo "============================================"
...
# Build command
CMD="CUDA_VISIBLE_DEVICES=0 python 0_filter_mmsu_text_semantic.py"
CMD="$CMD --harmful_texts_csv \"$HARMFUL_TEXTS_CSV\""
CMD="$CMD --output \"$OUTPUT\""
CMD="$CMD --cache_dir \"embedding_cache_text_semantic_mmsu\""
CMD="$CMD --device cuda"
...
echo "============================================"
echo ""
echo "Next step: Run 1_extract_semantic_tokens.sh with --benign_dataset mmsu --filter_type text_semantic"
