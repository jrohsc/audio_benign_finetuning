...
This provides a different filtering approach than acoustic embeddings:
- ACOUSTIC filtering: selects samples with similar audio characteristics
- SEMANTIC filtering: selects samples with similar text meaning
