...
Filter Spoken-SQuAD samples based on SEMANTIC embedding distance to harmful audio.
...
def main():
    parser = argparse.ArgumentParser(
        description="Filter Spoken-SQuAD by SEMANTIC embedding similarity to harmful audio"
    )
    ...
    parser.add_argument("--output", type=str, default="data_spoken_squad/spoken_squad_filtered_semantic.jsonl",
    ...
    spoken_squad_cache = os.path.join(args.cache_dir, "spoken_squad_semantic_embeddings.npy")
    ...
    if os.path.exists(spoken_squad_cache):
        ...
        print("Extracting Spoken-SQuAD SEMANTIC embeddings...")
    ...
    if args.center:
        ...
        np.save(os.path.join(args.cache_dir, "spoken_squad_semantic_embeddings_centered.npy"), embeddings)
