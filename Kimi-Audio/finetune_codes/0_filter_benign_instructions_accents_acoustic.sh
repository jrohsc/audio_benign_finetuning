...
# Output: data_acoustic_benign_instructions_accents/ folder
...
OUTPUT_DIR="data_acoustic_benign_instructions_accents"
...
OUTPUT="${OUTPUT_DIR}/benign_instructions_accents_filtered_acoustic_${OUTPUT_SUFFIX}.jsonl"
...
CMD="$CMD --cache_dir \"embedding_cache_acoustic_benign_instructions_accents\""
CMD="$CMD --device cuda"
