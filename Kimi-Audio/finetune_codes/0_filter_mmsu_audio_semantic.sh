#!/bin/bash
# =============================================================================
# AUDIO-BASED SEMANTIC FILTERING - MMSU (Multi-Subject Understanding)
# =============================================================================
#
# Filter MMSU samples by SEMANTIC embedding similarity to harmful audio.
# Uses GLM-4 Voice Tokenizer (WhisperVQEncoder) - captures WHAT is being said.
#
# Output: data_mmsu/ folder (for audio_semantic filter type)
#
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo ""
            echo "Filter MMSU by SEMANTIC embedding similarity to harmful audio."
            echo "Uses GLM-4 Voice Tokenizer (WhisperVQEncoder) - captures linguistic content."
            echo ""
            echo "Output: data_mmsu/ folder"
            echo ""
            echo "Options:"
            ...
            echo "  --output_dir PATH       Output directory (default: data_mmsu)"
...
OUTPUT="${OUTPUT_DIR}/mmsu_filtered_semantic_${OUTPUT_SUFFIX}.jsonl"

# Create output directory
mkdir -p "$OUTPUT_DIR"

echo "============================================"
echo "MMSU SEMANTIC Filtering"
echo "============================================"
...
# Build command
CMD="CUDA_VISIBLE_DEVICES=0 python 0_filter_mmsu_audio_semantic.py"
CMD="$CMD --harmful_dir \"$HARMFUL_DIR\""
CMD="$CMD --output \"$OUTPUT\""
CMD="$CMD --cache_dir \"embedding_cache_semantic_mmsu\""
CMD="$CMD --device cuda"
...
echo "============================================"
echo ""
echo "Next step: Run 1_extract_semantic_tokens.sh with --benign_dataset mmsu --filter_type audio_semantic"
echo "  bash 1_extract_semantic_tokens.sh --benign_dataset mmsu --filter_type audio_semantic --percentage $PERCENTAGE"
