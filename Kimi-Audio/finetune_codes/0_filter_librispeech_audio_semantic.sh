...
# =============================================================================
#
# Filter LibriSpeech samples by SEMANTIC embedding similarity to harmful audio.
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo ""
            echo "Filter LibriSpeech by SEMANTIC embedding similarity to harmful audio."
            echo "Uses GLM-4 Voice Tokenizer (WhisperVQEncoder) - captures linguistic content."
            echo ""
            echo "Output: data_librispeech/ folder"
            echo ""
            echo "Options:"
            ...
            echo "  --output_dir PATH       Output directory (default: data_librispeech)"
...
echo "============================================"
echo "LibriSpeech SEMANTIC Filtering"
echo "============================================"
...
# Build command
CMD="CUDA_VISIBLE_DEVICES=0 python 0_filter_librispeech_audio_semantic.py"
...
echo "============================================"
echo ""
echo "Next step: Run 1_extract_semantic_tokens.sh with --benign_dataset librispeech --filter_type audio_semantic"
echo "  bash 1_extract_semantic_tokens.sh --benign_dataset librispeech --filter_type audio_semantic --percentage $PERCENTAGE"
