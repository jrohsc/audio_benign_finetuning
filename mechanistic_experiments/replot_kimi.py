#!/usr/bin/env python3
"""Regenerate refusal feature figures for Kimi-Audio (WavLM filtering)."""
...
results_dir = Path("mechanistic_experiments/results/refusal_features_kimi_wavlm")
fig_dir = results_dir / "figures"
fig_dir.mkdir(parents=True, exist_ok=True)

# JSR from keyword ASR evaluation (AdvBench, wavlm filtering)
JSR = {
    "pretrained": 4.62,
    "wavlm_25pct": 34.62,
    "wavlm_50pct": 1.54,
...
DISPLAY_NAMES = {
    ...
    "wavlm_25pct": "WavLM 25%",
    "wavlm_50pct": "WavLM 50%",
    "wavlm_75pct": "WavLM 75%",
}
...
colors = {"pretrained": "#1f77b4", "wavlm_25pct": "#ff7f0e",
          "wavlm_50pct": "#2ca02c", "wavlm_75pct": "#d62728"}

for model_name in ["pretrained", "wavlm_25pct", "wavlm_50pct", "wavlm_75pct"]:
...
ax.set_title("Refusal Feature Strength Across Layers (Kimi-Audio, WavLM, AdvBench)", fontsize=14)
...
ft_models = ["wavlm_25pct", "wavlm_50pct", "wavlm_75pct"]
