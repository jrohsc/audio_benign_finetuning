#!/usr/bin/env python3
"""Regenerate refusal feature figures for Qwen2.5-Omni (SBERT Audio Semantic filtering)."""
...
results_dir = Path("mechanistic_experiments/results/refusal_features_qwen_sbert_audio_semantic")
fig_dir = results_dir / "figures"
fig_dir.mkdir(parents=True, exist_ok=True)

# JSR from keyword ASR evaluation (AdvBench, sbert_audio_semantic filtering)
JSR = {
    "pretrained": 0.19,
    "sbert_semantic_25pct": 9.42,
    "sbert_semantic_50pct": 12.50,
    "sbert_semantic_75pct": 2.69,
}
...
ax.set_title("Refusal Feature Strength Across Layers (Qwen2.5-Omni, SBERT Semantic, AdvBench)", fontsize=14)
